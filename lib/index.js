...
function (_React$Component) {
  ...
  _createClass(FormComponent, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", null, React.createElement("h1", null, this.state.message), React.createElement("input", {
        value: stateValue,
...
function (_React$Component) {
  ...
  _createClass(Button, [{
    key: "render",
    value: function render() {
      return React.createElement("button", null, "Hallo");
    }
  }]);
...
var components = [FormComponent, Button];
